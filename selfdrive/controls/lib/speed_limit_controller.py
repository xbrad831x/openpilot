...
_LIMIT_PERC_OFFSET_V = [0.1, 0.15, 0.15, 0.12,  0.2, 0.18, 0.17, 0.14, 0.065, 0.0]
_LIMIT_PERC_OFFSET_BP = [11.0, 13.4, 15.6, 20.1, 22.3, 24.58, 29.0, 31.2, 33.4, 35.7] #25, 30, 35, 45, 50, 55, 65, 70, 75, 80
